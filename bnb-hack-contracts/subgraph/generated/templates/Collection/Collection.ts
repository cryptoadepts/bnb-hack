...
export class Collection extends ethereum.SmartContract {
  ...
  lastItemId(): BigInt {
    let result = super.call("lastItemId", "lastItemId():(uint256)", []);

    return result[0].toBigInt();
  }

  try_lastItemId(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lastItemId", "lastItemId():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  values(param0: BigInt): BigInt {
    let result = super.call("values", "values(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_values(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("values", "values(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
